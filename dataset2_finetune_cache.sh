...
for MODEL_NAME in Salesforce/codegen-2B-multi  #bigcode/tiny_starcoder_py 
do
...
accelerate launch --num_processes $NP --cpu --config_file /home/ubuntu/Documents/kwedage_research/t5/t5-experiments/accelerate.yaml /home/ubuntu/Documents/kwedage_research/t5/t5-experiments/dataset2_finetune_cache.py \
        --task_name $TASK_NAME \
