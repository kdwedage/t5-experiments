...
if __name__ == '__main__':
    ...
    if args.model_type == 'encoder-decoder':
        ...
        tokenizer.add_special_tokens({'additional_special_tokens': ['[GEN]', '[PAD]', '<file_name_tag>', '<file_content_tag>', '<issue_tag>', '<file_type_tag>']})
        ...
        def collate_fn(batch):
            inputs = [b[0][:args.input_seq_len] for b in batch]
            labels = [b[1][:args.input_seq_len] for b in batch]
            ...
            # else:
            collated['target_text'] = [b[1] for b in batch]
            return collated
    ...
    # Kevin
    valid_dataset =  dataset['valid'] # [dataset['valid'][0]]
    ...
    def metrics_fn(data):
        ...
        if 'generation_outputs' in data:
            ...
            metrics['extended_edit_distance'] = eed(p,y) 
